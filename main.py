...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content ="""        This is an app build during my coding journey.
        This Student database management system helps you to keep the data organized 
         feel free to use this Application .
         
         contact me via phanivikash@gmail.com        
        """
